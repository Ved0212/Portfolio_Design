...
document.addEventListener('DOMContentLoaded', function() {
    var downloadCvBtn = document.getElementById('download-cv');
    if (downloadCvBtn) {
        downloadCvBtn.addEventListener('click', function(e) {
            e.preventDefault();
            // Replace 'cv.pdf' with the actual path to your CV file
            const link = document.createElement('a');
            link.href = 'Pradyum_resume.pdf';
            link.download = 'Pradyum_resume.pdf';
    ...
    var hireMeBtn = document.getElementById('hire-me');
    if (hireMeBtn) {
        hireMeBtn.addEventListener('click', function(e) {
            e.preventDefault();
            window.location.href = "#contact";
            // Optionally, smooth scroll if you want:
